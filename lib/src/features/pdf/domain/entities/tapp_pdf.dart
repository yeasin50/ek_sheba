...
enum TappPDF {
  ...
  // https://gwtraining.plandiv.gov.bd/external/mobile-apps/get-tapp-report/full/{{pcUuid}}
  full('${_baseUrl}get-tapp-report/full/');

  const TappPDF(this.path);
